...
<body>
<div class="container" style="padding-top:20px; border-radius: 6px; margin-top:20px; width:800px; box-shadow: 0 9px 20px 0 rgba(0, 0, 0, 0.5), 0 9px 40px 0 rgba(0, 0, 0, 0.5);">

	<form action="?controller=posts&action=add_category" onsubmit="return validateForm()"class="dropzone"method="post" name="form1" >
		...
		<div class="form-group">
			<lable class="control-lable col-sm-2">SEO_Title</lable>
			<div class="col-sm-10">
		...
		<div class="form-group">
			<lable class="control-lable col-sm-2">SEO_Description</lable>
			<div class="col-sm-10">
		...
		<div class="form-group">
			<lable class="control-lable col-sm-2">SEO_Keyword</lable>
			<div class="col-sm-10">
